...
_G.packer_plugins = {
  ...
  ["coq.thirdparty"] = {
    loaded = true,
    path = "/home/henryw/.local/share/nvim/site/pack/packer/start/coq.thirdparty"
  },
  coq_nvim = {
    loaded = true,
  ...
  ["nnn.vim"] = {
    loaded = false,
    needs_bufread = true,
    path = "/home/henryw/.local/share/nvim/site/pack/packer/opt/nnn.vim"
  },
  ["nvim-autopairs"] = {
  ...
  ["presence.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/henryw/.local/share/nvim/site/pack/packer/opt/presence.nvim"
  },
  ["project.nvim"] = {
  ...
  ["vim-maximizer"] = {
    config = { "\27LJ\2\n¤\1\0\0\6\0\t\0\r6\0\0\0009\0\1\0)\1\0\0=\1\2\0006\0\0\0009\0\3\0009\0\4\0'\2\5\0'\3\6\0'\4\a\0005\5\b\0B\0\5\1K\0\1\0\1\0\2\fnoremap\2\vsilent\2\25:MaximizerToggle<CR>\n<Del>\6n\20nvim_set_keymap\bapi\"maximizer_set_default_mapping\6g\bvim\0" },
    loaded = true,
...
-- Conditional loads
time("Condition for { 'telescope-fzf-native.nvim', 'presence.nvim', 'nvim-treesitter-context', 'nnn.vim' }", true)
if
try_loadstring("\27LJ\2\nE\0\0\3\0\4\1\v6\0\0\0009\0\1\0009\0\2\0'\2\3\0B\0\2\2\t\0\0\0X\0\2€+\0\1\0X\1\1€+\0\2\0L\0\2\0\nwin32\bhas\afn\bvim\2\0", "condition", '{ "telescope-fzf-native.nvim", "presence.nvim", "nvim-treesitter-context", "nnn.vim" }')
then
time("Condition for { 'telescope-fzf-native.nvim', 'presence.nvim', 'nvim-treesitter-context', 'nnn.vim' }", false)
