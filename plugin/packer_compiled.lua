...
_G.packer_plugins = {
  ...
  ["telescope.nvim"] = {
    after = { "telescope-fzf-native.nvim", "project.nvim", "telescope-frecency.nvim" },
    loaded = true,
    only_config = true
  },
  ["tex-conceal.vim"] = {
...
-- Conditional loads
time("Condition for { 'telescope-fzf-native.nvim', 'nvim-treesitter-context', 'telescope-frecency.nvim' }", true)
if
try_loadstring("\27LJ\2\nE\0\0\3\0\4\1\v6\0\0\0009\0\1\0009\0\2\0'\2\3\0B\0\2\2\t\0\0\0X\0\2€+\0\1\0X\1\1€+\0\2\0L\0\2\0\nwin32\bhas\afn\bvim\2\0", "condition", '{ "telescope-fzf-native.nvim", "nvim-treesitter-context", "telescope-frecency.nvim" }')
then
time("Condition for { 'telescope-fzf-native.nvim', 'nvim-treesitter-context', 'telescope-frecency.nvim' }", false)
